    ...
    return (
        <main className="flex min-h-screen flex-col items-center px-[0.3rem] md:px-24 py-10">
            <div className="z-10 w-full max-w-3xl items-center justify-between font-mono text-sm lg:flex">
                ...
                <div
                    className="fixed bottom-0 left-0 flex h-48 w-full items-end justify-center bg-gradient-to-t from-white via-white dark:from-black dark:via-black lg:static lg:size-auto lg:bg-none space-x-2 lg:space-x-6">
                    <button className="flex place-items-center p-5 sm:p-8 lg:pointer-events-auto lg:p-0" onClick={()=>{
